...
def main(args):
    ...
    subprocess.run(["bedtools", "getfasta", "-fi", options.reference, "-bed", del_coord_file.name, "-nameOnly", "-fo", del_seq_file_name])
    subprocess.run(["bedtools", "getfasta", "-fi", options.query, "-bed", ins_coord_file.name, "-nameOnly", "-fo", ins_seq_file_name])
